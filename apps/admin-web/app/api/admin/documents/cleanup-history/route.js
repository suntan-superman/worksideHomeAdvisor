...
export async function POST(request) {
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/api/v1/admin/documents/cleanup-history`, {
      method: 'POST',
      headers: {
    ...
    return NextResponse.json({ message: error.message || 'Document cleanup failed.' }, { status: 500 });
  }
}
