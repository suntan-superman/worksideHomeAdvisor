...
const leadRequestSchema = new mongoose.Schema(
  {
    ...
    sellerNotificationChannels: { type: [String], default: [] },
...
const leadDispatchSchema = new mongoose.Schema(
  {
    ...
    responseStatus: {
      type: String,
      enum: ['accepted', 'declined', 'help', 'opted_out', 'custom_reply', 'no_response', 'already_matched', null],
      default: null,
    },
...
const providerResponseSchema = new mongoose.Schema(
  {
    ...
    responseStatus: {
      type: String,
      enum: ['accepted', 'declined', 'help', 'opted_out', 'custom_reply', 'no_response', 'already_matched'],
      required: true,
    },
