...
export const VISION_PRESETS = [
  ...
  },
  {
    ...
    upgradeTier: 'premium',
    basePrompt:
      'Create a conceptual preview of this room with the walls clearly repainted in a warm neutral tone suitable for broad buyer appeal. Change the wall color enough that the repaint is immediately noticeable, while preserving trim, ceilings, windows, built-ins, flooring, furniture, and layout. Keep the image realistic and suitable for showing a paint concept only.',
    helperText:
  ...
  },
  {
    ...
    upgradeTier: 'premium',
    basePrompt:
      'Create a conceptual preview of this room with the walls repainted a bright white tone for a clean and airy listing presentation. Make the white-wall repaint clearly brighter and more noticeable than the source while preserving architecture, trim, shadows, flooring, furniture, and layout. Keep the result realistic and clearly a concept preview.',
    helperText:
  ...
  },
  {
    ...
    upgradeTier: 'premium',
    basePrompt:
      'Create a conceptual preview of this room with the walls changed to a soft greige tone that feels modern and buyer-friendly. Make the wall-tone shift clearly visible while preserving the room’s true structure, trim, flooring, furniture, and layout. Keep the output realistic and suitable for listing-planning visualization.',
    helperText:
