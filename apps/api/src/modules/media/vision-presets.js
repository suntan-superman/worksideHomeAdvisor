...
export const VISION_PRESETS = [
  ...
  },
  {
    ...
    upgradeTier: 'premium',
    basePrompt:
      'Create a conceptual preview of this room with the walls repainted a bright white tone for a clean and airy listing presentation. Make the white-wall repaint clearly brighter and more noticeable than the source at first glance while preserving architecture, trim, shadows, flooring, furniture, and layout. Keep the result realistic and clearly a concept preview.',
    helperText:
